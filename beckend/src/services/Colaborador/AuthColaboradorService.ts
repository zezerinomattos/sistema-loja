...
class AuthColaboradorService {
    async execute({ email, senha }: AuthRequest){
        ...
        return {
            ...
            salario_liquido: user.colaborador[0].salario_liquido, 
            complemento_salario: user.colaborador[0].complemento_salario, 
            adiantamento_salario: user.colaborador[0].adiantamento_salario, 
            saldo_salario: user.colaborador[0].adiantamento_salario, 
            limite_credito: user.colaborador[0].limite_credito, 
