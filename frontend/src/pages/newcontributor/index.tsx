...
export default function Register(){
    ...
    async function hadleRegiste(event: FormEvent){
        ...
        try {
            ...
            //Verificações
            if(!nome || !cpf || !nascimento || !sexo || !email || !cep || !logradouro || !numero || !bairro || !cidade || !uf || !pais || !situacao || !celular || !telefone || !rg || !orgao_emissor || !carteira_trabalho ||!serie || !pais || !titulo_eleitor || !zona_eleitoral||!secao_eleitoral ||!complemento_salario || !senha || !cargo || !imageAvatar){             
